...
with open("./ChatBot/word_index_dict","rb") as f:
    word_index_dict=pickle.load(f)

with open("./ChatBot/index_word_dict","rb") as f:
...
with open("./ChatBot/weights/encoder.pt", "rb") as f:
    weights_encoder=pickle.load(f)

with open("./ChatBot/weights/decoder.pt", "rb") as f:
    weights_decoder=pickle.load(f)

with open("./ChatBot/weights/attention.pt", "rb") as f:
